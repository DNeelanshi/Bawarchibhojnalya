...
@IonicPage()
@Component({
  selector: 'page-cancelorderviewcalendar',
  templateUrl: 'cancelorderviewcalendar.html',
})
export class CancelorderviewcalendarPage {
...
str2:any;
  constructor(public navCtrl: NavController, 
      ...
      private loadCtrl:LoadingController, public http: Http) {
